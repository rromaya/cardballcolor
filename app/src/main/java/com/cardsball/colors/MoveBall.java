...
public class MoveBall {
    ...
    Paint paint;                                                                                                                                                                                                                     // The paint style, custom used for drawing

    // Constructor
    public MoveBall(float x, float y, float radius, int color, float speed, float dx, float dy) {
        this.x = x;
        this.y = y;
        this.radius = radius;
        if (dx == 0 && dy == 0) {
    ...
    public void moveWithCollisionDetection(BackCalculating back) {
